...
from fastapi.middleware.cors import CORSMiddleware # Crucial: Import CORSMiddleware
...
# --- CORS Configuration ---
# This block allows your frontend (even when run locally) to make requests to your deployed API.
# In a production environment, you might want to restrict origins to your specific frontend URL
# for enhanced security instead of using ["*"].
origins = ["*"]  # Allows all origins, necessary for local HTML testing
